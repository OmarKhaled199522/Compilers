...
#define BOOL_OP 264
#define INT_WORD 265
#define FLOAT_WORD 266
#define BOOLEAN_WORD 267
#define IF_WORD 268
#define ELSE_WORD 269
#define WHILE_WORD 270
#define FOR_WORD 271
#define SYSTEM_OUT 272
...
{
       0,   124,   124,   124,   147,   149,   156,   162,   163,   164,
     165,   166,   167,   170,   183,   184,   185,   188,   194,   211,
     226,   246,   275,   304,   305,   306,   307,   327,   330,   347,
     365,   378
};
#endif
...
static const char *const yytname[] =
{
  ...
  "ARITH_OP", "RELA_OP", "BOOL_OP", "INT_WORD", "FLOAT_WORD",
  "BOOLEAN_WORD", "IF_WORD", "ELSE_WORD", "WHILE_WORD", "FOR_WORD",
  "SYSTEM_OUT", "';'", "'='", "'('", "')'", "'{'", "'}'", "$accept",
  "METHOD_BODY", "$@1", "STATEMENT_LIST", "LABEL", "STATEMENT",
  "DECLARATION", "PRIMITIVE_TYPE", "GOTO", "IF", "WHILE", "FOR",
  "ASSIGNMENT", "ASSIGNMENT_", "EXPRESSION", "SIMPLE_EXPRESSION",
  "SYSTEMOUT", YY_NULLPTR
};
#endif
...
{
     -31,    15,    30,   -31,     4,   -31,   -31,   -31,    18,    25,
      29,   -31,    41,     7,   -31,    55,   -31,   -31,   -31,   -31,
     -31,     0,     8,    56,     0,   -31,    43,    30,    46,   -31,
     -31,   -31,     0,    14,   -31,    52,     1,   -31,    10,     8,
     -31,   -31,    12,     0,   -31,     0,   -31,    47,     8,    50,
      16,   -31,   -31,    58,     8,   -31,    39,   -31,    48,   -31,
      30,   -31,   -31,   -31,    65,    30,    49,    54,    53,    57,
      61,     0,    59,   -31,    60,    58,   -31,   -31,   -31,    30,
      30,    62,   -31,   -31,    63,   -31
};
...
{
       2,     0,     6,     1,     0,    14,    15,    16,     0,     0,
       0,     6,     0,     6,     7,     0,     8,     9,    10,    11,
      12,     0,     0,     0,     0,     3,     0,     6,     0,    24,
      23,    26,     0,     0,    28,     0,     0,     6,     0,     0,
       5,    13,     0,     0,    21,     0,     6,     0,     0,     0,
       0,    27,    25,    30,     0,     6,     0,    31,     0,    29,
       6,     6,     6,    17,     0,     6,     0,     0,     0,     0,
       0,     0,     0,    19,     0,    22,    17,     6,     6,     6,
       6,     0,    17,    18,     0,    20
};
...
{
     -31,   -31,   -31,   -26,   -11,   -31,   -31,   -31,   -24,   -31,
     -31,   -31,    64,   -31,   -16,   -30,   -31
};
...
{
      25,    40,    27,    29,    30,    33,    31,    -4,    38,    50,
      46,    29,    30,    34,    31,     3,    42,    43,    56,    43,
      32,    43,    47,    21,    59,    46,    48,    52,    32,    53,
      -4,    49,    44,    51,    63,    54,     4,    58,    22,    69,
       5,     6,     7,     8,    60,    23,     9,    10,    46,    24,
      64,    65,    78,    81,    82,    75,    26,    61,    84,    43,
      45,    28,     4,    39,    41,    43,    79,    80,    57,    55,
      62,    67,    70,    71,    72,    74,     0,     0,     0,     0,
      73,    76,    77,     0,     0,    83,    85,    37
};

static const yytype_int8 yycheck[] =
{
      11,    27,    13,     3,     4,    21,     6,     0,    24,    39,
       9,     3,     4,     5,     6,     0,    32,     7,    48,     7,
      20,     7,    21,    19,    54,     9,    37,    43,    20,    45,
      23,    21,    18,    21,    60,    46,     6,    21,    20,    65,
      10,    11,    12,    13,    55,    20,    16,    17,     9,    20,
      61,    62,    76,    79,    80,    71,    15,    18,    82,     7,
       8,     6,     6,    20,    18,     7,    77,    78,    18,    22,
      22,     6,    23,    19,    21,    14,    -1,    -1,    -1,    -1,
      23,    22,    22,    -1,    -1,    23,    23,    23
};
...
{
       0,    25,    26,     0,     6,    10,    11,    12,    13,    16,
      17,    27,    28,    29,    30,    31,    33,    34,    35,    36,
      40,    19,    20,    20,    20,    28,    15,    28,     6,     3,
       4,     6,    20,    38,     5,    38,    39,    36,    38,    20,
      27,    18,    38,     7,    18,     8,     9,    21,    28,    21,
      39,    21,    38,    38,    28,    22,    39,    18,    21,    39,
      28,    18,    22,    27,    28,    28,    32,     6,    37,    27,
      23,    19,    21,    23,    14,    38,    22,    22,    32,    28,
      28,    27,    27,    23,    32,    23
};
...
#line 140 "syntax.y" /* yacc.c:1646  */
    {
		setCodeSteps((yyvsp[-1].stmt_type).nextList,(yyvsp[0].intValue));
		codeSteps.push_back(("return"));
		codeSteps.push_back((".end method"));
	}
...
#line 150 "syntax.y" /* yacc.c:1646  */
    {
		setCodeSteps((yyvsp[-2].stmt_type).nextList,(yyvsp[-1].intValue));
...
#line 171 "syntax.y" /* yacc.c:1646  */
    {
		string str((yyvsp[-1].idValue));
		if((yyvsp[-2].type) == INT_T)
		{
			setAllowedVariables(str,INT_T);
		}else if ((yyvsp[-2].type) == FLOAT_T)
		{
...
#line 203 "syntax.y" /* yacc.c:1646  */
    {
		setCodeSteps((yyvsp[-11].bexpr_type).trueList,(yyvsp[-8].intValue));
		setCodeSteps((yyvsp[-11].bexpr_type).falseList,(yyvsp[-2].intValue));
		(yyval.stmt_type).nextList = getNextStep((yyvsp[-7].stmt_type).nextList, (yyvsp[-1].stmt_type).nextList);
		(yyval.stmt_type).nextList->push_back((yyvsp[-6].intValue));
	}
...
#line 216 "syntax.y" /* yacc.c:1646  */
    {
		string s = "Label" + to_string((yyvsp[-8].intValue));
		codeSteps.push_back(("goto " + s));

		setCodeSteps((yyvsp[-1].stmt_type).nextList,(yyvsp[-8].intValue));
		setCodeSteps((yyvsp[-5].bexpr_type).trueList,(yyvsp[-2].intValue));
...
#line 233 "syntax.y" /* yacc.c:1646  */
    {
		setCodeSteps((yyvsp[-10].bexpr_type).trueList,(yyvsp[-3].intValue));
		vector<int> * v = new vector<int> ();
		v->push_back((yyvsp[-4].intValue));
		setCodeSteps(v,(yyvsp[-11].intValue));
		v = new vector<int>();
		v->push_back((yyvsp[-1].intValue));
		setCodeSteps(v,(yyvsp[-8].intValue));
		setCodeSteps((yyvsp[-2].stmt_type).nextList,(yyvsp[-8].intValue));
...
#line 276 "syntax.y" /* yacc.c:1646  */
    {
	string str((yyvsp[-2].idValue));
	/* after EXPRESSION finishes, its result should be on top of stack.
	we just store the top of stack to the identifier*/
	if(checkId(str))
	{
		if((yyvsp[0].expr_type) == symbolTable[str].second)
		{
			if((yyvsp[0].expr_type) == INT_T)
			{
				codeSteps.push_back(("istore " + to_string(symbolTable[str].first)));
			}else if ((yyvsp[0].expr_type) == FLOAT_T)
			{
				codeSteps.push_back(("fstore " + to_string(symbolTable[str].first)));
			}
			}
...
#line 304 "syntax.y" /* yacc.c:1646  */
    {(yyval.expr_type) = FLOAT_T; codeSteps.push_back(("bipush "+to_string((yyvsp[0].floatValue))));}
#line 1594 "y.tab.c" /* yacc.c:1646  */
    break;

  case 24:
#line 305 "syntax.y" /* yacc.c:1646  */
    {(yyval.expr_type) = INT_T;  codeSteps.push_back(("bipush "+to_string((yyvsp[0].intValue))));}
#line 1600 "y.tab.c" /* yacc.c:1646  */
    break;

  case 25:
#line 306 "syntax.y" /* yacc.c:1646  */
    {castGeneralOperations((yyvsp[-2].expr_type), (yyvsp[0].expr_type), string((yyvsp[-1].aopValue)));}
...
#line 307 "syntax.y" /* yacc.c:1646  */
    {
		string str((yyvsp[0].idValue));
		if(checkId(str))
		{
			(yyval.expr_type) = symbolTable[str].second;
...
#line 331 "syntax.y" /* yacc.c:1646  */
    {
		if((yyvsp[0].boolValue))
		{
			...
			(yyval.bexpr_type).trueList->push_back(codeSteps.size());
			...
			}else
			{
				(yyval.bexpr_type).trueList = new vector<int> ();
				(yyval.bexpr_type).falseList= new vector<int>();
				(yyval.bexpr_type).falseList->push_back(codeSteps.size());
				codeSteps.push_back(("goto "));
			}
		}
...
#line 351 "syntax.y" /* yacc.c:1646  */
    {
			if(!strcmp((yyvsp[-2].aopValue), "&&"))
			{
				setCodeSteps((yyvsp[-3].bexpr_type).trueList, (yyvsp[-1].intValue));
				(yyval.bexpr_type).trueList = (yyvsp[0].bexpr_type).trueList;
				(yyval.bexpr_type).falseList = getNextStep((yyvsp[-3].bexpr_type).falseList,(yyvsp[0].bexpr_type).falseList);
			}
			else if (!strcmp((yyvsp[-2].aopValue),"||"))
			{
				setCodeSteps((yyvsp[-3].bexpr_type).falseList,(yyvsp[-1].intValue));
				(yyval.bexpr_type).trueList = getNextStep((yyvsp[-3].bexpr_type).trueList, (yyvsp[0].bexpr_type).trueList);
...
#line 366 "syntax.y" /* yacc.c:1646  */
    {
			string op ((yyvsp[-1].aopValue));
			(yyval.bexpr_type).trueList = new vector<int>();
			(yyval.bexpr_type).trueList ->push_back (codeSteps.size());
			(yyval.bexpr_type).falseList = new vector<int>();
			(yyval.bexpr_type).falseList->push_back(codeSteps.size()+1);
...
#line 379 "syntax.y" /* yacc.c:1646  */
    {
		...
		}else if ((yyvsp[-2].expr_type) == FLOAT_T)
		{
