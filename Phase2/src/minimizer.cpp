...
void minimizer::build_final_automata()
{
    ...
    p->start_recognizing();
    final_tokens = p->output_file_lines;
    //***************************************************************************
}
